import { dg as createCompounder, jK as memoize, fx as i18n, gb as HTTP_REQUEST_NODE_TYPE, jL as getCredentialOnlyNodeType, fi as CUSTOM_API_CALL_KEY, b1 as AI_SUBCATEGORY, d as defineComponent, cz as reactive, o as onMounted, v as onBeforeUnmount, aP as toRefs, l as resolveComponent, c as openBlock, h as createElementBlock, j as createBaseVNode, i as createVNode, n as normalizeClass, f as createCommentVNode, aK as useExternalHooks, _ as _export_sfc, r as ref, p as computed, ft as DEFAULT_SUBCATEGORY, jM as CREDENTIAL_ONLY_NODE_PREFIX, dt as isCommunityPackageName, cD as resolveDirective, e as createBlock, aJ as createSlots, w as withCtx, aw as withDirectives, A as unref, dw as COMMUNITY_NODES_INSTALLATION_DOCS_URL, ds as _sfc_main$h, B as normalizeStyle, I as withModifiers, ax as vShow, g as useI18n, gD as DRAG_EVENT_DATA_KEY, gC as getNewNodePosition, gE as NODE_SIZE, ak as useTelemetry, aS as mergeProps, t as toDisplayString, dK as WEBHOOK_NODE_TYPE, q as renderSlot, T as useWorkflowsStore, H as watch, aQ as normalizeProps, aR as guardReactiveProps, aX as onUnmounted, F as Fragment, z as renderList, fR as REGULAR_NODE_CREATOR_VIEW, u as useUsersStore, fM as TRIGGER_NODE_CREATOR_VIEW, js as OPEN_AI_NODE_TYPE, jr as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, de as withMemo, bM as createStaticVNode, k as createTextVNode, jN as REQUEST_NODE_FORM_URL, K as useUIStore, Z as useRootStore, jO as getNodeIconUrl, jP as getNodeIcon, jQ as getNodeIconColor, fy as AI_NODE_CREATOR_VIEW, fz as AI_OTHERS_NODE_CREATOR_VIEW, J as useDebounce, bw as Transition, hP as useAssistantStore, dS as useCredentialsStore, bf as useNodeTypesStore, jR as SlideTransition } from "./index-40I5DMGP.js";
import { f as formatTriggerActionName, u as useNodeCreatorStore, a as useViewStacks, c as camelCase, b as useKeyboardNavigation, t as transformNodeType, d as flattenCreateElements, T as TriggerView, R as RegularView, A as AIView, e as AINodesView } from "./NodeViewSwitcher-CNfOOUof.js";
import { d as upperFirst, b as useNodeType } from "./useRunWorkflow-MrEKURG4.js";
import { u as useActions } from "./NodeCreation-CDpNw3BL.js";
...
function operationsCategory(nodeTypeDescription) {
  ...
  if (!(matchedProperty == null ? void 0 : matchedProperty.options)) return [];
...
function modeCategory(nodeTypeDescription) {
  var _a, _b;
  const isAINode = (_b = (_a = nodeTypeDescription.codex) == null ? void 0 : _a.categories) == null ? void 0 : _b.includes(AI_SUBCATEGORY);
  if (!isAINode) return [];
  const matchedProperty = nodeTypeDescription.properties.find(
    (property) => {
      var _a2;
      return ((_a2 = property.name) == null ? void 0 : _a2.toLowerCase()) === "mode";
    }
  );
  if (!(matchedProperty == null ? void 0 : matchedProperty.options)) return [];
...
function resourceCategories(nodeTypeDescription) {
  ...
  matchedProperties.forEach((property) => {
    (property.options || []).filter((option) => option.value !== CUSTOM_API_CALL_KEY).forEach((resourceOption, _i, options) => {
      ...
      if (!(operations == null ? void 0 : operations.options)) return;
...
function useActionsGenerator() {
  function generateNodeActions(node) {
    var _a, _b, _c;
    if (!node) return [];
    if ((_c = (_b = (_a = node.codex) == null ? void 0 : _a.subcategories) == null ? void 0 : _b.AI) == null ? void 0 : _c.includes("Tools")) return [];
    return [
...
const searchContainer = "_searchContainer_dci3d_1";
const prefix = "_prefix_dci3d_17";
const active$3 = "_active_dci3d_22";
const text = "_text_dci3d_26";
const suffix = "_suffix_dci3d_42";
const clear = "_clear_dci3d_48";
const style0$e = {
  searchContainer,
  prefix,
  active: active$3,
...
const nodeItem = "_nodeItem_124lg_1";
const nodeIcon$2 = "_nodeIcon_124lg_9";
const subNodeBackground = "_subNodeBackground_124lg_13";
const communityNodeIcon = "_communityNodeIcon_124lg_23";
const draggable$1 = "_draggable_124lg_27";
const draggableDataTransfer$1 = "_draggableDataTransfer_124lg_41";
const style0$d = {
  nodeItem,
  nodeIcon: nodeIcon$2,
  subNodeBackground,
...
const subCategory = "_subCategory_qrigt_1";
const style0$c = {
  subCategory
};
const cssModules$c = {
...
const action$1 = "_action_139su_1";
const nodeIcon$1 = "_nodeIcon_139su_13";
const draggable = "_draggable_139su_17";
const draggableDataTransfer = "_draggableDataTransfer_139su_31";
const style0$a = {
  action: action$1,
  nodeIcon: nodeIcon$1,
  draggable,
...
const creatorLink = "_creatorLink_1hx0p_1";
const style0$8 = {
  creatorLink
};
const cssModules$8 = {
...
const triggerIcon = "_triggerIcon_b4ocq_1";
const category$1 = "_category_b4ocq_6";
const active$2 = "_active_b4ocq_27";
const name = "_name_b4ocq_31";
const arrow = "_arrow_b4ocq_36";
const style0$7 = {
  triggerIcon,
  category: category$1,
  active: active$2,
...
const mouseOverTooltip = "_mouseOverTooltip_1smyb_1";
const categorizedItemsRenderer = "_categorizedItemsRenderer_1smyb_9";
const tooltipPopper = "_tooltipPopper_1smyb_13";
const contentSlot = "_contentSlot_1smyb_17";
const style0$6 = {
  mouseOverTooltip,
...
const itemSkeleton = "_itemSkeleton_1rgyl_1";
const iteratorItem = "_iteratorItem_1rgyl_5";
const label = "_label_1rgyl_17";
const category = "_category_1rgyl_17";
const active$1 = "_active_1rgyl_20";
const empty = "_empty_1rgyl_24";
const itemsRenderer = "_itemsRenderer_1rgyl_28";
const view = "_view_1rgyl_37";
const link = "_link_1rgyl_55";
const borderless = "_borderless_1rgyl_73";
const style0$5 = {
  itemSkeleton,
  iteratorItem,
  label,
  ...
  setup(__props, { emit: __emit }) {
    ...
    function onSelected(actionCreateElement) {
      ...
      if (isPlaceholderTriggerAction && isTriggerRootView.value) {
        const actionNode = (_a = actions.value[0]) == null ? void 0 : _a.key;
        if (actionNode) emit("nodeTypeSelected", [actionData.key, actionNode]);
      } else if ((actionData == null ? void 0 : actionData.key) === OPEN_AI_NODE_TYPE && ((_b = actionData == null ? void 0 : actionData.value) == null ? void 0 : _b.resource) === "assistant" && ((_c = actionData == null ? void 0 : actionData.value) == null ? void 0 : _c.operation) === "message") {
    ...
    function addHttpNode() {
      ...
      const app_identifier = (_a = actions.value[0]) == null ? void 0 : _a.key;
...
const container = "_container_25ezu_1";
const resetSearch = "_resetSearch_25ezu_7";
const actionsEmpty = "_actionsEmpty_25ezu_21";
const apiHint = "_apiHint_25ezu_29";
const style0$4 = {
  container,
  resetSearch,
  actionsEmpty,
...
const noResults = "_noResults_8axui_1";
const title$1 = "_title_8axui_14";
const action = "_action_8axui_23";
const request = "_request_8axui_24";
const icon = "_icon_8axui_40";
const external = "_external_8axui_46";
const style0$3 = {
  noResults,
  title: title$1,
  action,
  ...
  setup(__props, { emit: __emit }) {
    ...
    function onSelected(item) {
      ...
      if (item.type === "node") {
        ...
        const icon2 = iconUrl ? rootStore.baseUrl + iconUrl : (_a = getNodeIcon(item.properties, uiStore.appliedTheme)) == null ? void 0 : _a.split(":")[1];
...
const info = "_info_vhrjt_23";
const backButton = "_backButton_vhrjt_27";
const backButtonIcon = "_backButtonIcon_vhrjt_34";
const nodeIcon = "_nodeIcon_vhrjt_40";
const renderedItems = "_renderedItems_vhrjt_45";
const searchBar = "_searchBar_vhrjt_57";
const nodesListPanel = "_nodesListPanel_vhrjt_61";
const footer = "_footer_vhrjt_79";
const top = "_top_vhrjt_90";
const header = "_header_vhrjt_95";
const hasBg = "_hasBg_vhrjt_101";
const title = "_title_vhrjt_106";
const subtitle = "_subtitle_vhrjt_116";
const offsetSubtitle = "_offsetSubtitle_vhrjt_124";
const style0$1 = {
  info,
  backButton,
  backButtonIcon,
...
const nodeCreator = "_nodeCreator_1dtlx_5";
const nodeCreatorScrim = "_nodeCreatorScrim_1dtlx_16";
const active = "_active_1dtlx_28";
const style0 = {
  nodeCreator,
  nodeCreatorScrim,
  active
