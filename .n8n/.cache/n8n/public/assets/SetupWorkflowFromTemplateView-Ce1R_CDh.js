import { R as defineStore, r as ref, aH as useTemplatesStore, bf as useNodeTypesStore, dS as useCredentialsStore, Z as useRootStore, T as useWorkflowsStore, p as computed, iD as useCredentialSetupState, V as VIEWS, gz as tryToParseNumber, aK as useExternalHooks, ak as useTelemetry, d as defineComponent, hj as usePostHog, U as useRoute, b as useRouter, H as watch, av as onBeforeMount, iE as TEMPLATE_CREDENTIAL_SETUP_EXPERIMENT, o as onMounted, c as openBlock, e as createBlock, w as withCtx, A as unref, iF as N8nHeading, k as createTextVNode, t as toDisplayString, j as createBaseVNode, n as normalizeClass, iG as AppsRequiringCredsNotice, h as createElementBlock, F as Fragment, z as renderList, iH as SetupTemplateFormStep, i as createVNode, eh as N8nLink, g as useI18n, l as resolveComponent, _ as _export_sfc } from "./index-40I5DMGP.js";
import { c as createWorkflowFromTemplate } from "./templateActions-D4EHdA9n.js";
...
const useSetupTemplateStore = defineStore("setupTemplate", () => {
  ...
  const templateNodes = computed(() => {
    var _a;
    return ((_a = template.value) == null ? void 0 : _a.workflow.nodes) ?? [];
  });
  const {
    appCredentials,
    credentialOverrides,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const title = computed(() => {
      var _a;
      return ((_a = setupTemplateStore.template) == null ? void 0 : _a.name) ?? "unknown";
    });
...
const grid = "_grid_6bgsx_1";
const notice = "_notice_6bgsx_9";
const appCredentialsContainer = "_appCredentialsContainer_6bgsx_13";
const appCredential = "_appCredential_6bgsx_13";
const actions = "_actions_6bgsx_24";
const style0 = {
  grid,
  notice,
