import { d as defineComponent, iQ as useUsageStore, U as useRoute, b as useRouter, K as useUIStore, u as useUsersStore, a as useToast, a3 as useDocumentTitle, a5 as usePageRedirectionHelper, r as ref, p as computed, o as onMounted, fx as i18n, c as openBlock, h as createElementBlock, i as createVNode, w as withCtx, k as createTextVNode, t as toDisplayString, A as unref, n as normalizeClass, e as createBlock, f as createCommentVNode, j as createBaseVNode, B as normalizeStyle, eA as InfoTip, I as withModifiers, iR as COMMUNITY_PLUS_ENROLLMENT_MODAL, l as resolveComponent, an as hasPermission, am as getResourcePermissions, iS as telemetry, _ as _export_sfc } from "./index-40I5DMGP.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const canUserRegisterCommunityPlus = computed(
      () => {
        var _a;
        return getResourcePermissions((_a = usersStore.currentUser) == null ? void 0 : _a.globalScopes).community.register;
      }
    );
...
const center = "_center_1cion_1";
const actionBox = "_actionBox_1cion_5";
const spacedFlex = "_spacedFlex_1cion_9";
const title = "_title_1cion_15";
const quota = "_quota_1cion_21";
const count = "_count_1cion_33";
const buttons = "_buttons_1cion_38";
const chart = "_chart_1cion_54";
const chartLine = "_chartLine_1cion_61";
const chartBar = "_chartBar_1cion_71";
const titleTooltip = "_titleTooltip_1cion_85";
const style0 = {
  center,
  actionBox,
  spacedFlex,
