import { d as defineComponent, l as resolveComponent, c as openBlock, h as createElementBlock, i as createVNode, n as normalizeClass, _ as _export_sfc, au as useExecutionsStore, a as useToast, r as ref, p as computed, cD as resolveDirective, j as createBaseVNode, t as toDisplayString, e as createBlock, A as unref, F as Fragment, z as renderList, w as withCtx, k as createTextVNode, aw as withDirectives, C as createEventBus, U as useRoute, T as useWorkflowsStore, m as useSettingsStore, f as createCommentVNode, V as VIEWS, i4 as ElDropdown, g as useI18n, ae as MODAL_CONFIRM, al as useMessage, am as getResourcePermissions, a8 as EnterpriseEditionFeature } from "./index-40I5DMGP.js";
import { u as useExecutionDebugging } from "./useExecutionDebugging-LQQWXhPj.js";
import { _ as _sfc_main$3, u as useExecutionHelpers } from "./useExecutionHelpers-CXGl_HIp.js";
...
const ratingIcon$1 = "_ratingIcon_1wqgu_1";
const up = "_up_1wqgu_5";
const down = "_down_1wqgu_8";
const style0$2 = {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const vote2 = computed(() => {
      var _a, _b;
      return ((_b = (_a = activeExecution.value) == null ? void 0 : _a.annotation) == null ? void 0 : _b.vote) || null;
    });
    const tagIds = computed(() => {
      var _a, _b;
      return ((_b = (_a = activeExecution.value) == null ? void 0 : _a.annotation) == null ? void 0 : _b.tags.map((tag) => tag.id)) ?? [];
    });
    const tags = computed(() => {
      var _a, _b;
      return (_b = (_a = activeExecution.value) == null ? void 0 : _a.annotation) == null ? void 0 : _b.tags;
    });
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", null, toDisplayString(_ctx.$locale.baseText("generic.rating")), 1),
          ...
          createBaseVNode("span", {
            ...
            isTagsEditEnabled.value ? (openBlock(), createBlock(_sfc_main$3, {
              ...
              placeholder: _ctx.$locale.baseText("executionAnnotationView.chooseOrCreateATag"),
              class: "tags-edit",
              ...
              }, " + " + toDisplayString(_ctx.$locale.baseText("executionAnnotationView.addTag")), 3)
              ...
              createBaseVNode("span", {
                ...
                createVNode(_component_n8n_button, {
                  ...
                  label: `+ ` + _ctx.$locale.baseText("executionAnnotationView.addTag"),
                  type: "secondary",
                  size: "mini",
                  outline: false,
                  text: true,
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", {
            ...
            createVNode(_component_n8n_heading, {
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString(_ctx.$locale.baseText("generic.annotationData")), 1)
              ]),
              _: 1
            })
          ], 2),
          ((_a = activeExecution.value) == null ? void 0 : _a.customData) && Object.keys((_b = activeExecution.value) == null ? void 0 : _b.customData).length > 0 ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: normalizeClass(_ctx.$style.metadata)
          }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys((_c = activeExecution.value) == null ? void 0 : _c.customData), (attr) => {
              return openBlock(), createElementBlock("div", {
                key: attr,
                ...
                createVNode(_component_n8n_text, {
                  ...
                  default: withCtx(() => {
                    var _a2;
                    return [
                      createTextVNode(toDisplayString((_a2 = activeExecution.value) == null ? void 0 : _a2.customData[attr]), 1)
                    ];
                  }),
                  _: 2
                }, 1032, ["class"])
            ...
            createVNode(_component_n8n_text, {
              ...
              default: withCtx(() => [
                withDirectives(createBaseVNode("span", null, null, 512), [
                  [_directive_n8n_html, _ctx.$locale.baseText("executionAnnotationView.data.notFound")]
                ])
              ]),
              _: 1
            })
...
const container = "_container_umkw2_1";
const section = "_section_umkw2_17";
const metadata = "_metadata_umkw2_26";
const heading = "_heading_umkw2_30";
const controls = "_controls_umkw2_37";
const vote = "_vote_umkw2_49";
const ratingIcon = "_ratingIcon_umkw2_58";
const highlight = "_highlight_umkw2_62";
const customDataEntry = "_customDataEntry_umkw2_66";
const key = "_key_umkw2_73";
const noResultsContainer = "_noResultsContainer_umkw2_77";
const tagsContainer = "_tagsContainer_umkw2_87";
const addTag = "_addTag_umkw2_97";
const addTagStandalone = "_addTagStandalone_umkw2_108";
const addTagWrapper = "_addTagWrapper_umkw2_112";
const style0$1 = {
  container,
  section,
  metadata,
  ...
  key,
  noResultsContainer,
  "execution-annotation-panel": "_execution-annotation-panel_umkw2_82",
  "el-skeleton__item": "_el-skeleton__item_umkw2_82",
  tagsContainer,
  addTag,
  addTagStandalone,
  addTagWrapper
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const workflowPermissions = computed(
      () => {
        var _a;
        return getResourcePermissions((_a = workflowsStore.getWorkflowById(workflowId.value)) == null ? void 0 : _a.scopes).workflow;
      }
    );
    ...
    const debugButtonData = computed(
      () => {
        var _a;
        return ((_a = props.execution) == null ? void 0 : _a.status) === "success" ? {
    ...
    const hasAnnotation = computed(
      () => {
        var _a, _b, _c;
        return !!((_a = props.execution) == null ? void 0 : _a.annotation) && (((_b = props.execution) == null ? void 0 : _b.annotation.vote) || ((_c = props.execution) == null ? void 0 : _c.annotation.tags.length) > 0);
      }
    );
    ...
    return (_ctx, _cache) => {
      ...
      return ((_a = executionUIDetails.value) == null ? void 0 : _a.name) === "new" ? (openBlock(), createElementBlock("div", {
        key: 0,
      ...
      ], 2)) : ((_b = executionUIDetails.value) == null ? void 0 : _b.name) === "running" ? (openBlock(), createElementBlock("div", {
        key: 1,
          ...
          createBaseVNode("div", null, [
            createVNode(_component_N8nText, {
              ...
              default: withCtx(() => {
                var _a2;
                return [
                  createTextVNode(toDisplayString((_a2 = executionUIDetails.value) == null ? void 0 : _a2.startTime), 1)
                ];
              }),
              _: 1
            }),
            _cache[1] || (_cache[1] = createBaseVNode("br", null, null, -1)),
            ((_c = executionUIDetails.value) == null ? void 0 : _c.name) === "running" ? (openBlock(), createBlock(_component_N8nSpinner, {
              key: 0,
              size: "small",
            ...
            ((_d = executionUIDetails.value) == null ? void 0 : _d.showTimestamp) === false ? (openBlock(), createBlock(_component_N8nText, {
              key: 1,
              color: "text-base",
              size: "medium"
            }, {
              ...
              default: withCtx(() => {
                ...
                return [
                  createTextVNode(toDisplayString(unref(locale).baseText("executionDetails.runningTimeFinished", {
                    interpolate: { time: ((_a2 = executionUIDetails.value) == null ? void 0 : _a2.runningTime) ?? "unknown" }
                  })) + " | ID#" + toDisplayString(_ctx.execution.id), 1)
                ];
              }),
              _: 1
        ...
        createVNode(WorkflowPreview, {
          mode: "execution",
          "loader-type": "spinner",
          "execution-id": executionId.value,
          "execution-mode": ((_e = _ctx.execution) == null ? void 0 : _e.mode) || ""
        }, null, 8, ["execution-id", "execution-mode"])
      ], 2)) : createCommentVNode("", true);
    };
  }
});
const previewContainer = "_previewContainer_duwst_1";
const executionDetails = "_executionDetails_duwst_7";
const spinner = "_spinner_duwst_26";
const running = "_running_duwst_32";
const waiting = "_waiting_duwst_37";
const success = "_success_duwst_41";
const error = "_error_duwst_45";
const newInfo = "_newInfo_duwst_49";
const runningInfo = "_runningInfo_duwst_50";
const newMessage = "_newMessage_duwst_57";
const runningMessage = "_runningMessage_duwst_58";
const debugLink = "_debugLink_duwst_64";
const style0 = {
  previewContainer,
  executionDetails,
  spinner,
