import { d as defineComponent, r as ref, p as computed, o as onMounted, c as openBlock, h as createElementBlock, q as renderSlot, j as createBaseVNode, t as toDisplayString, i as createVNode, w as withCtx, k as createTextVNode, e as createBlock, A as unref, f as createCommentVNode, n as normalizeClass, I as withModifiers, g as useI18n, l as resolveComponent, j2 as dateformat, _ as _export_sfc, F as Fragment, z as renderList, aC as get, R as defineStore, Z as useRootStore, m as useSettingsStore, T as useWorkflowsStore, iJ as getNewWorkflow, U as useRoute, b as useRouter, a as useToast, a5 as usePageRedirectionHelper, K as useUIStore, av as onBeforeMount, V as VIEWS, be as watchEffect, iS as telemetry, am as getResourcePermissions, aq as h, j8 as WORKFLOW_HISTORY_VERSION_RESTORE } from "./index-40I5DMGP.js";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    onMounted(() => {
      ...
      isAuthorElementTruncated.value = (((_b = authorElement.value) == null ? void 0 : _b.scrollWidth) ?? 0) > (((_c = authorElement.value) == null ? void 0 : _c.clientWidth) ?? 0);
    });
    return (_ctx, _cache) => {
...
const item = "_item_1a4du_1";
const tail = "_tail_1a4du_33";
const active = "_active_1a4du_38";
const actionsVisible = "_actionsVisible_1a4du_45";
const actions = "_actions_1a4du_45";
const style0$3 = {
  item,
  tail,
  active,
      ...
      return openBlock(), createElementBlock("ul", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(props.items, (item2, index) => {
          ...
          return openBlock(), createBlock(WorkflowHistoryListItem, {
            ...
            index,
            item: item2,
            "is-active": item2.versionId === ((_a = props.activeItem) == null ? void 0 : _a.versionId),
...
const list = "_list_undzg_1";
const empty = "_empty_undzg_10";
const loader = "_loader_undzg_23";
const retention = "_retention_undzg_27";
const style0$2 = {
  list,
  empty,
  loader,
...
const content = "_content_2kwc4_1";
const info = "_info_2kwc4_11";
const card = "_card_2kwc4_19";
const text = "_text_2kwc4_24";
const label = "_label_2kwc4_49";
const style0$1 = {
  content,
  info,
  card,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isFirstItemShown = computed(() => {
      var _a;
      return ((_a = workflowHistory.value[0]) == null ? void 0 : _a.versionId) === versionId.value;
    });
    ...
    const normalizeSingleRouteParam = (name) => {
      ...
      return (param == null ? void 0 : param[0]) ?? "";
    };
...
const view = "_view_phdlt_1";
const header = "_header_phdlt_11";
const corner = "_corner_phdlt_19";
const contentComponentWrapper = "_contentComponentWrapper_phdlt_30";
const listComponentWrapper = "_listComponentWrapper_phdlt_35";
const style0 = {
  view,
  header,
  corner,
