import { d as defineComponent, aZ as useClipboard, a as useToast, m as useSettingsStore, K as useUIStore, u as useUsersStore, ij as useSSOStore, a3 as useDocumentTitle, a5 as usePageRedirectionHelper, p as computed, o as onMounted, c as openBlock, h as createElementBlock, j as createBaseVNode, i as createVNode, w as withCtx, k as createTextVNode, t as toDisplayString, A as unref, n as normalizeClass, f as createCommentVNode, e as createBlock, F as Fragment, z as renderList, g as useI18n, ik as INVITE_USER_MODAL_KEY, l as resolveComponent, an as hasPermission, a8 as EnterpriseEditionFeature, il as ROLE, _ as _export_sfc } from "./index-40I5DMGP.js";
  ...
  setup(__props) {
    ...
    const usersListActions = computed(() => {
      return [
        ...
        },
        {
          ...
          guard: (user) => {
            var _a;
            return settingsStore.isSamlLoginEnabled && !((_a = user.settings) == null ? void 0 : _a.allowSSOManualLogin);
          }
        },
        {
          ...
          guard: (user) => {
            var _a;
            return settingsStore.isSamlLoginEnabled && ((_a = user.settings) == null ? void 0 : _a.allowSSOManualLogin) === true;
          }
        }
      ];
    });
    ...
    async function onRoleChange(user, newRoleName) {
      ...
      try {
        ...
        const role = ((_a = userRoles.value.find(({ value }) => value === newRoleName)) == null ? void 0 : _a.label) || newRoleName;
        showToast({
          type: "success",
