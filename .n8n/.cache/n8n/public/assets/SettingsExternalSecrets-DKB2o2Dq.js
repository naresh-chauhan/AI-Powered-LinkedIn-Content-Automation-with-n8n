import { d as defineComponent, gp as useExternalSecretsStore, K as useUIStore, a as useToast, cS as toRef, p as computed, iT as useExternalSecretsProvider, o as onMounted, c as openBlock, e as createBlock, w as withCtx, j as createBaseVNode, i as createVNode, n as normalizeClass, iU as _sfc_main$2, k as createTextVNode, t as toDisplayString, A as unref, f as createCommentVNode, h as createElementBlock, iV as ExternalSecretsProviderConnectionSwitch, g as useI18n, x as nextTick, iW as EXTERNAL_SECRETS_PROVIDER_MODAL_KEY, l as resolveComponent, aF as DateTime, iX as isDateObject, _ as _export_sfc, a3 as useDocumentTitle, a5 as usePageRedirectionHelper, F as Fragment, z as renderList } from "./index-40I5DMGP.js";
                ...
                default: withCtx(() => {
                  ...
                  return [
                    createBaseVNode("span", null, toDisplayString(unref(i18n).baseText("settings.externalSecrets.card.secretsCount", {
                      interpolate: {
                        count: `${(_a = unref(externalSecretsStore).secrets[provider.value.name]) == null ? void 0 : _a.length}`
                      }
                    })), 1),
...
const card = "_card_yvq6o_1";
const cardImage = "_cardImage_yvq6o_6";
const cardBody = "_cardBody_yvq6o_11";
const cardContent = "_cardContent_yvq6o_17";
const cardActions = "_cardActions_yvq6o_24";
const warningTriangle = "_warningTriangle_yvq6o_31";
const style0 = {
  card,
  cardImage,
  cardBody,
