...
import { u as usePushConnection } from "./usePushConnection-B5ija5f5.js";
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(tags.value, (tag) => {
              return openBlock(), createElementBlock("span", {
                ...
                tag.isCount ? (openBlock(), createBlock(_component_el_tag, {
                  ...
                  _: 2
                }, 1032, ["title"])) : (openBlock(), createBlock(_sfc_main$c, {
                  key: 1,
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    onMounted(() => {
      ...
      (_a = props.eventBus) == null ? void 0 : _a.on("focus", focus);
    });
    onBeforeUnmount(() => {
      var _a;
      (_a = props.eventBus) == null ? void 0 : _a.off("focus", focus);
    });
    function focus() {
      if (inputRef.value) {
  ...
  setup(__props) {
    ...
    const collaboratorsSorted = computed(() => {
      ...
      const index = users.findIndex((user) => {
        var _a;
        return user.id === ((_a = usersStore.currentUser) == null ? void 0 : _a.id);
      });
  ...
  setup(__props) {
    ...
    const workflowMenuItems = computed(() => {
      ...
      actions.push({
        ...
        label: nodeViewVersion.value === "2" ? locale.baseText("menuActions.switchToOldNodeViewVersion") : locale.baseText("menuActions.switchToNewNodeViewVersion"),
        disabled: !onWorkflowPage.value
      });
      if (workflowPermissions.value.delete && !props.readOnly || isNewWorkflow.value) {
        actions.push({
    ...
    function onShareButtonClick() {
      ...
      telemetry.track("User opened sharing modal", {
        ...
        user_id_sharer: (_a = usersStore.currentUser) == null ? void 0 : _a.id,
    ...
    function onWorkflowMenuOpen(visible) {
    ...
    async function onWorkflowMenuSelect(action) {
      ...
      switch (action) {
        ...
        case WORKFLOW_MENU_ACTIONS.IMPORT_FROM_FILE: {
          (_a = importFileRef.value) == null ? void 0 : _a.click();
          break;
        }
      ...
      return openBlock(), createElementBlock("div", {
        ...
        unref(settingsStore).areTagsEnabled ? (openBlock(), createElementBlock("span", _hoisted_1$1, [
          isTagsEditEnabled.value && !_ctx.readOnly && (isNewWorkflow.value || workflowPermissions.value.update) ? (openBlock(), createBlock(_sfc_main$f, {
            ...
            onBlur: onTagsBlur,
            onEsc: onTagsEditEsc
          }, null, 8, ["modelValue", "event-bus", "placeholder"])) : (_ctx.tags ?? []).length === 0 && !_ctx.readOnly && (isNewWorkflow.value || workflowPermissions.value.update) ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
          ...
          default: withCtx(() => [
                ...
                createVNode(_component_N8nTooltip, null, {
                  content: withCtx(() => [
                    createVNode(_component_i18n_t, {
                      ...
                      action: withCtx(() => [
                        createBaseVNode("a", { onClick: goToUpgrade }, toDisplayString(_ctx.$locale.baseText(
            ...
            createBaseVNode("div", {
              ...
              createVNode(SaveButton, {
                ...
                "shortcut-tooltip": _ctx.$locale.baseText("saveWorkflowButton.hint"),
            ...
            createBaseVNode("div", {
              ...
              createVNode(_component_N8nTooltip, { visible: unref(isNodeViewDiscoveryTooltipVisible) }, {
                content: withCtx(() => [
                  createBaseVNode("div", _hoisted_4, [
                    createVNode(_component_N8nBadge, null, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(_ctx.$locale.baseText("menuActions.badge.alpha")), 1)
                      ]),
                      _: 1
                    })
                  ]),
                  createTextVNode(" " + toDisplayString(_ctx.$locale.baseText("menuActions.nodeViewDiscovery.tooltip")) + " ", 1),
                  createVNode(_component_N8nIcon, {
                    class: normalizeClass(unref($style).closeNodeViewDiscovery),
                    icon: "times-circle",
                    onClick: unref(setNodeViewSwitcherDiscovered)
                ...
                default: withCtx(() => [
                  createVNode(_component_N8nActionDropdown, {
                    ...
                    onVisibleChange: onWorkflowMenuOpen
                  }, null, 8, ["items"])
                ]),
                _: 1
              }, 8, ["visible"])
...
const container$1 = "_container_gpe2m_1";
const group = "_group_gpe2m_9";
const hiddenInput = "_hiddenInput_gpe2m_14";
const deleteItem = "_deleteItem_gpe2m_18";
const disabledShareButton = "_disabledShareButton_gpe2m_22";
const closeNodeViewDiscovery = "_closeNodeViewDiscovery_gpe2m_26";
const style1 = {
...
const WorkflowDetails = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$1], ["__scopeId", "data-v-26802e45"]]);
...
const container = "_container_1ndnk_1";
const style0 = {
  container
};
const cssModules = {
...
const TabBar = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__cssModules", cssModules]]);
...
const _hoisted_2 = { class: "top-menu" };
const _hoisted_3 = { class: "github-button" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function syncTabsWithRoute(to, from) {
      if (to.name === VIEWS.EXECUTION_HOME || to.name === VIEWS.WORKFLOW_EXECUTIONS || to.name === VIEWS.EXECUTION_PREVIEW) {
        activeHeaderTab.value = MAIN_HEADER_TABS.EXECUTIONS;
      } else if (to.name === VIEWS.WORKFLOW || to.name === VIEWS.NEW_WORKFLOW || to.name === VIEWS.EXECUTION_DEBUG) {
      ...
      if ((from == null ? void 0 : from.name) === VIEWS.EXECUTION_PREVIEW && to.params.name === from.params.name && typeof from.params.executionId === "string") {
    ...
    async function navigateToExecutionsView(openInNewTab) {
      ...
      const executionToReturnToValue = ((_a = executionsStore.activeExecution) == null ? void 0 : _a.id) || executionToReturnTo.value;
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", {
          class: normalizeClass({ "main-header": true, expanded: !unref(uiStore).sidebarMenuCollapsed })
        }, [
          withDirectives(createBaseVNode("div", _hoisted_2, [
            ((_a = workflow.value) == null ? void 0 : _a.name) ? (openBlock(), createBlock(WorkflowDetails, {
              key: 0,
