import { d as defineComponent, aa as useCssModule, b as useRouter, r as ref, p as computed, fo as WAIT_TIME_UNLIMITED, fx as i18n, l as resolveComponent, c as openBlock, h as createElementBlock, j as createBaseVNode, e as createBlock, f as createCommentVNode, n as normalizeClass, I as withModifiers, t as toDisplayString, i as createVNode, w as withCtx, A as unref, k as createTextVNode, g as useI18n, V as VIEWS, _ as _export_sfc, T as useWorkflowsStore, au as useExecutionsStore, m as useSettingsStore, a as useToast, a8 as EnterpriseEditionFeature, H as watch, o as onMounted, aw as withDirectives, ax as vShow, F as Fragment, z as renderList, bx as TransitionGroup, ae as MODAL_CONFIRM, am as getResourcePermissions, ak as useTelemetry, al as useMessage, U as useRoute, a3 as useDocumentTitle, el as storeToRefs, av as onBeforeMount, v as onBeforeUnmount, aK as useExternalHooks } from "./index-40I5DMGP.js";
import { _ as _sfc_main$3, E as ExecutionsFilter } from "./ExecutionsTime.vue_vue_type_script_setup_true_lang-Ba-at9rw.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["stop", "select", "retrySaved", "retryOriginal", "delete"],
  setup(__props, { emit: __emit }) {
    ...
    const statusTooltipText = computed(() => {
      if (props.execution.status === "waiting" && isWaitTillIndefinite.value) {
        return i18n$1.baseText("executionsList.statusTooltipText.theWorkflowIsWaitingIndefinitely");
      }
      return "";
    });
      ...
      return openBlock(), createElementBlock("tr", {
        ...
        createBaseVNode("td", null, [
          createBaseVNode("div", {
            ...
            !isWaitTillIndefinite.value ? (openBlock(), createBlock(_component_i18n_t, {
              key: 1,
              ...
              time: withCtx(() => [
                _ctx.execution.waitTill ? (openBlock(), createElementBlock("span", _hoisted_1$1, toDisplayString(formattedWaitTillDate.value), 1)) : !!_ctx.execution.stoppedAt ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(formattedStoppedAtDate.value), 1)) : _ctx.execution.status !== "new" ? (openBlock(), createBlock(_sfc_main$3, {
                  key: 2,
                  "start-time": _ctx.execution.startedAt
                }, null, 8, ["start-time"])) : createCommentVNode("", true)
              ]),
              _: 1
            }, 8, ["keypath"])) : (openBlock(), createBlock(_component_N8nTooltip, {
              key: 2,
              placement: "top"
            }, {
              content: withCtx(() => [
                createBaseVNode("span", null, toDisplayString(statusTooltipText.value), 1)
              ]),
              default: withCtx(() => [
                createBaseVNode("span", {
                  class: normalizeClass(_ctx.$style.status)
...
const executionListItem = "_executionListItem_1fozm_1";
const crashed = "_crashed_1fozm_30";
const error = "_error_1fozm_30";
const success = "_success_1fozm_33";
const running = "_running_1fozm_39";
const waiting = "_waiting_1fozm_42";
const unknown = "_unknown_1fozm_45";
const link = "_link_1fozm_49";
const statusColumn = "_statusColumn_1fozm_55";
const spinner = "_spinner_1fozm_60";
const status = "_status_1fozm_55";
const buttonCell = "_buttonCell_1fozm_89";
const style0$1 = {
  executionListItem,
  crashed,
  error,
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function getWorkflowName(workflowId) {
      var _a;
      return (_a = workflows.value.find((data) => data.id === workflowId)) == null ? void 0 : _a.name;
    }
            ...
            createVNode(TransitionGroup, {
              ...
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.executions, (execution) => {
                  ...
                  }, null, 8, ["execution", "workflow-name", "workflow-permissions", "selected"]);
                }), 128))
              ]),
              _: 1
            })
...
const execListWrapper = "_execListWrapper_nwoof_1";
const execList = "_execList_nwoof_1";
const execListHeader = "_execListHeader_nwoof_17";
const execListHeaderControls = "_execListHeaderControls_nwoof_24";
const selectionOptions = "_selectionOptions_nwoof_30";
const execTable = "_execTable_nwoof_48";
const loadMore = "_loadMore_nwoof_91";
const loadedAll = "_loadedAll_nwoof_97";
const actions = "_actions_nwoof_104";
const deleteOnly = "_deleteOnly_nwoof_104";
const retryAction = "_retryAction_nwoof_108";
const deleteAction = "_deleteAction_nwoof_108";
const selectAll = "_selectAll_nwoof_112";
const filterLoader = "_filterLoader_nwoof_118";
const tableLoader = "_tableLoader_nwoof_123";
const style0 = {
  execListWrapper,
  execList,
  execListHeader,
...
const GlobalExecutionsList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__cssModules", cssModules], ["__scopeId", "data-v-73ba2d96"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function loadWorkflows() {
      var _a;
      try {
        await workflowsStore.fetchAllWorkflows((_a = route.params) == null ? void 0 : _a.projectId);
      } catch (error2) {
